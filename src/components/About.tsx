  ...
  const data = [

    {
        ...
        content: (
          <div className="font-jost">
            <p className="  text-xl font-normal mb-8 text-slate-300">
             Currently Full Stack Developer
            </p>
            <p className="text-neutral-800 dark:text-neutral-200 text-sm font-normal mb-8">Expertise in Full Stack Development including 
      ...
      },
    {
      ...
      <p className="  text-xl font-normal mb-8 text-slate-300">
          ...
          <p className="text-neutral-800 dark:text-neutral-200 text-sm font-normal mb-8">Enrolled in bachelor of software engineering program in Sindh Medrassatul Islam University.</p>
